                ...
                <div>
                    ...
                    <select onChange={(e) => {
                        if(e.target.value == "line"){
                            this.setState({showLine: true, showHorizontalBar: false, showBar: false})
                        }
                        else if(e.target.value == "bar"){
                            this.setState({showLine: false, showHorizontalBar: false, showBar: true})            
                        }
                        else{
                            this.setState({showLine: false, showHorizontalBar: true, showBar: false})
                        }
                    }}>
